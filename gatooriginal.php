...
echo "<br><div id='titulo'>Gato e Gata</div><br>";
ativo($meuid,'Gato e Gata');
if($a=="a"||$a==FALSE){
...
$fg =  $result->rowCount();
echo "<p align='center'>";
echo "<img src='/imagens/gato.gif' alt='gatogata'/></br>";
echo "</p>";
echo "<div><img src='/imagens/atencao.png' alt='sobre'/> <a href=\"/gato?a=regras\">Sobre o Gato e Gata</a></div>";
echo "<div><img src=\"/imagens/gato.png\" alt=\"\"/><a title=\"Entre\" href=\"/gato?a=gatover&id=m2g\">Gatos Inscritos</a>($mg)<br></div>";
echo "<div><img src=\"/imagens/gata.png\" alt=\"\"/><a title=\"Entre\" href=\"/gato?a=gatover&id=f2g\">Gatas Inscritas</a>($fg)<br></div>";
...
$result->execute();
$fg =  $result->rowCount();
echo "<div><img src=\"/imagens/gato.png\" alt=\"\"/><a title=\"Enter\" href=\"/gato?a=gatover&id=m2g\">Gatos Inscritos</a>($mg)<br></div>";
echo "<div><img src=\"/imagens/gata.png\" alt=\"\"/><a title=\"Enter\" href=\"/gato?a=gatover&id=f2g\">Gatas Inscritas</a>($fg)<br></div>";
echo "<p align='center'>";
echo "<img src='imagens/gato.gif' alt='Gato e Gata'/><a href=\"/gato\">Gato e Gata</a></br>";
echo "</p>";
}else 
if($a=="gatover"){
if($pag==""){
...
if($a=="add"){
echo "<p>";
echo "Inscreva-se para o Gato e Gata deste mes</p><br><br>";
...
echo "<img src='/imagens/gato.gif' alt='gato'/><a href=\"/gato\">Gato e Gata</a></br>";
echo "</p>";
}
if ($problems==""){
...
if($a == "regras"){
echo "<div>Você podera votar em uma Gata e um Gato e a cada voto sera adicionado automaticamente 500 pontos em seu perfil.</div><br>";
echo "<p align='center'>";
echo "<img src='/imagens/gato.gif' alt='gatogata'/><a href=\"/gato\">Gato e Gata</a></br>";
echo "</p>";
}else 
...
$fg = $result->rowCount();
echo "<p align='center'>";
echo "<img src='/imagens/notok.gif' alt='x'/><br>As inscriçôes deste mes já terminaram<br>";
echo "</p>";
echo "<div>Você podera votar em uma gata e um gato e a cada voto sera adicionado automaticamente 500 pontos em seu perfil.</div><br>";
echo "<div><img src=\"/imagens/gato.png\" alt=\"\"/><a title=\"Enter\" href=\"/gato?a=gatover&id=m2g\">Escolha um gato pra votar</a>($mg)<br></div>";
echo "<div><img src=\"/imagens/gata.png\" alt=\"\"/><a title=\"Enter\" href=\"/gato?a=gatover&id=f2g\">Escolha uma gata pra votar</a>($fg)<br></div>";
if(perm($meuid)==3 or perm($meuid)==4){
...
if($res){
echo "<p align='center'>";
echo "<img src='/imagens/ok.gif' alt='ok'/><br>Gato e Gata zerado com sucesso<br>";
echo "</p>";
}else{
echo "<p align='center'>";
echo "<img src='/imagens/notok.gif' alt='atencao'/><br>Erro ao zerar Gato e Gata<br>";
echo "</p>";
}
}
if($e == "limparv"){
